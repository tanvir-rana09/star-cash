...
const SignUp = () => {
  ...
  const { error, loading, callApi, data } = useApi('/register', 'POST');
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mb-5">
                    <Button
                      loading={loading}
                      type="submit"
                      className="w-full cursor-pointer rounded border-blue bg-green-500 p-4 py-2.5 text-white transition hover:bg-opacity-90"
                    >
                      Sign Up
                    </Button>
                  </div>
